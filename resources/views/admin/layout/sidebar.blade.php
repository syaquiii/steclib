<div class="h-screen w-77 fixed flex rounded-r-2xl shadow-2xl flex-col items-center py-16 bg-[#F6F4F1]">
    <div class="text-[#1F305E] font-fraunces italic">
        <h2 class="text-5xl font-bold">Steclib</h2>
        <span>Admin</span>
    </div>
    <ul class="mt-12 text-[#805B4E] text-xl font-semibold w-full">
        <a href="{{ route('admin.dashboard') }}"
            class="{{ Request::routeIs('admin.dashboard') ? 'bg-[#1F305E] text-white' : '' }} hover:bg-[#1F305E] hover:text-white transition-all px-8 py-4 flex justify-between gap-4 items-center">
